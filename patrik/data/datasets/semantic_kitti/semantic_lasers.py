...
if __name__ == '__main__':
    import yaml
    with open('config/semantic_kitti.yaml', 'r') as f:
        color_dict = yaml.load(f, Loader=yaml.Loader)

    learning_map = color_dict['learning_map']

    laser = SemLaserScan(10, color_dict['color_map'])

    laser.open_scan('/home/patrik/data/semantic-kitti/04/velodyne/000000.bin')
    laser.open_label('/home/patrik/data/semantic-kitti/04/labels/000000.label')

    import pptk
    pptk.viewer(laser.points[:,:3], laser.sem_label)
